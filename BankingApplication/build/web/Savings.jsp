<%-- 
    Document   : Savings
    Created on : Oct 21, 2019, 12:16:15 PM
    Author     : taran
--%>
...
<body>
    ...
    <%user.retrieve((Integer) session.getAttribute("ClientID"));
        String save;
        ArrayList<String> transactions = user.getTransactions_Savings(6);
        String Balance = "____";
        ...
        if(user.savings_Exists()){
            ...
            session.setAttribute("AccountNumber", (int) user.savings.get_account_number());
            
            Balance = "$ " + String.valueOf(user.savings.get_balance());
            Interest = String.valueOf(user.savings.get_APR()) + "%";
            AccountNumber = String.valueOf(user.savings.get_account_number());
            RoutingNumber = String.valueOf(user.savings.get_routing());
        }
        else{
            out.println("<h1>No Savings Account Registered </h1>");
        }
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="card text-left">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><a href="AddAccount?request=6">Report Fraud</a></li>
                        <li class="list-group-item"><a href="AddAccount?request=5">Overdraft Protection</a></li>
                    </ul>
